...
"%JAVA%" %KC_OPTS% -cp "%DIRNAME%\client\keycloak-admin-cli-26.2.1.jar" --add-opens=java.base/java.security=ALL-UNNAMED -Dkc.lib.dir="%DIRNAME%\client\lib" org.keycloak.client.admin.cli.KcAdmMain %*
