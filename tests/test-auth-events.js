/**
 * Script de teste para verificar a sequência de eventos de autenticação do whatsapp-web.js v1.33.2
 * 
 * Este script testa:
 * 1. Sequência completa de eventos de autenticação
 * 2. Evento 'authenticated' que deve ocorrer antes do 'ready'
...
console.log('Iniciando teste de eventos de autenticação com whatsapp-web.js v1.33.2...');

// Inicializar cliente com as mesmas configurações do app.js
const client = new Client({
  authStrategy: new LocalAuth({ clientId: 'test-auth-events' }),
  puppeteer: {
